...
function App() {
  ...
  return (
    <div className="flex items-center justify-center w-screen h-screen py-10">
      <div className="bg-gray-300 flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto">
        {/* form card section  */}
        <div className="form-container">
          <div className="flex items-center justify-center">
            <h3
              className="my-auto mr-auto text-xl text-teal-900 font-bold shadow-md py-1 px-3 
